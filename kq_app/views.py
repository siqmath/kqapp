...
def novo_pedido(request):
    try:
        ...
        logger.error(f"ERRO AO CARREGAR P\u00c1GINA novo_pedido: {e}", exc_info=True)
        return render(request, 'kq_app/erro.html', {'mensagem': f'Erro interno ao carregar a p\u00e1gina: {e}'})
